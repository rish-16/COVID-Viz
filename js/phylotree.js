! function(t) {
    ...
    (function() {
        ...
        function g(t, e) {
            ...
            function r() {
                var t = n[n.length - 1];
                "children" in t || (t.children = []), n.push({
                    name: null
                }), t.children.push(n[n.length - 1]), n[n.length - 1].original_child_order = t.children.length
            }
        ...
        d3.layout.newick_parser = function(t, e) {
            ...
            return draw_branch = Z, draw_scale_bar = null, rescale_node_span = 1, count_listener_handler = function() {}, layout_listener_handler = function() {}, node_styler = void 0, edge_styler = void 0, shown_font_size = H, selection_attribute_name = "selected", popover_displayed = null, right_most_leaf = 0, label_width = 0, radial_center = 0, radius = 1, radius_pad_for_bubbles = 0, radial_mapper = function(t, e) {
                ...
                }, null) || 1, Y[0].x = d(Y[0]), h = d3.max(Y, function(t) {
                    return t.depth
                }), a && u && (a = !1, Y[0].x = d(Y[0]));
                var y = !1;
                ...
                if (draw_scale_bar) {
                    ...
                    if (draw_scale_bar = d3.svg.axis().scale(C).orient("top").tickFormat(function(t) {
                        ...
                        var L = C.ticks();
                        L = L.length > 1 ? L[1] : L[0], draw_scale_bar.ticks(Math.min(10, d3.round(D / (shown_font_size * k(L).length * .8), 0)))
                    }
                ...
                if (e.empty() && (e = d3.select(A.container).append("ul").attr("id", "d3_layout_phylotree_context_menu").attr("class", "dropdown-menu").attr("role", "menu")), e.selectAll("li").remove(), t) {
                    ...
                    }), e.append("li").attr("class", "divider"), e.append("li").attr("class", "dropdown-header").text("Toggle selection")), F.selectable && (e.append("li").append("a").attr("tabindex", "-1").text("All descendant branches").on("click", function(n) {
                    ...
                    }), n.length && (e.append("li").attr("class", "divider"), n.forEach(function(n) {
                ...
                n && (Y = D.call(this, e)).forEach(function(t) {
                    t.id = null
                }), et.placenodes(), z = et.links(Y), et.sync_edge_labels(), r = et, i = new CustomEvent(t, {
                ...
                return arguments.length ? (B !== t && (B = t, "phylotree-container" == j["tree-container"] && (B.selectAll("*").remove(), svg_defs = B.append("defs")), d3.select(A.container).on("click", function(t) {
                ...
                if (et.sync_edge_labels(), F.zoom) {
                    var v = d3.behavior.zoom().scaleExtent([.1, 10]).on("zoom", function() {
                        ...
                        t[0] += Q[1] + F["left-offset"], t[1] += et.pad_height(), d3.select("." + j["tree-container"]).attr("transform", "translate(" + t + ")scale(" + d3.event.scale + ")")
                    });
                    B.call(v)
                }
                return et
                ...
                if (t = d3.select(t), l(e)) {
                    var r = t.selectAll("text").data([e]),
                        i = t.selectAll("line");
                    if (n ? r.enter().append("text").style("opacity", 0).transition().style("opacity", 1) : r.enter().append("text"), r.on("click", function(t, e) {
                ...
                return V
            }, d3.rebind(et, D, "sort", "children", "value"), et.nodes = et, et.links = d3.layout.cluster().links, et
        }, d3.layout.phylotree.is_leafnode = l, d3.layout.phylotree.add_custom_menu = function(t, e, n, r) {
            "menu_items" in t || (t.menu_items = []), t.menu_items.some(function(t) {
                return t[0] == e && t[1] == n && t[2] == r
            }) || t.menu_items.push([e, n, r])
        }, d3.layout.phylotree.trigger_refresh = m, d3.layout.phylotree.nexml_parser = function(t) {
            var e;
